...
import 'package:dekornata_submission_test/widgets/formfield_container.dart';
import 'package:dekornata_submission_test/widgets/input_dropdown.dart';
        ...
        Positioned(
          ...
          child: FloatingActionButton(
            ...
            onPressed: () async {
              ...
              setState(() {
                _selected = File(pickedFile.path);
              });
            },
          ),
        ),
